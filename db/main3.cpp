...
int main(int argc, char* argv[]) {
    ...
    tree.printNodeAttribute2(7,1);
    tree.printNodeAttribute2(0,0);
    tree.printNodeAttribute2(4,0);
    tree.printNodeAttribute2(11,0);

    printf("probando querie 4.2) get edgeatribute (id,label):\n");
    tree.printEdgeAttribute2(1,3);


    printf("probando querie 5.1) get node atribute value (type,att,value):\n");
    tree.printNodeAttributeValue2("nodeType1",0,"IT");

    printf("probando querie 5.2) get edge atribute value (type,att,value):\n");
    tree.printEdgeAttributeValue2("edgeType3",0,"NUEVO");

    printf("probando querie 6.1) get node neighbours (type,id):\n");
    tree.printNeighbourNodes2("nodeType2",0);
