...
int main(int argc, char* argv[]) {
    ...
    fpsize=fopen("./resultsml100k/size.txt", "w");
    fpinsert=fopen("./resultsml100k/insertions.txt", "w");
    fpqueries=fopen("./resultsml100k/queries.txt", "w");
...
*/
    ...
    diff=0;
    start = clock();
    tree.getNodeAttributeValue("nodeType0",0,"7");
    tree.getNodeAttributeValue("nodeType0",0,"14");
    tree.getNodeAttributeValue("nodeType0",0,"25");
    tree.getNodeAttributeValue("nodeType0",0,"30");
    tree.getNodeAttributeValue("nodeType0",0,"49");
    tree.getNodeAttributeValue("nodeType0",0,"50");
    tree.getNodeAttributeValue("nodeType0",0,"68");
    tree.getNodeAttributeValue("nodeType0",0,"71");
    tree.getNodeAttributeValue("nodeType0",0,"86");
    tree.getNodeAttributeValue("nodeType0",0,"99");
    diff += clock() - start;
    ...
    diff=0;
    start = clock();
    tree.getNodeAttributeValue("nodeType0",1,"M");
    tree.getNodeAttributeValue("nodeType0",1,"M");
    diff += clock() - start;
    ...
    diff=0;
    start = clock();
    tree.getNodeAttributeValue("nodeType0",2,"administrator");
    tree.getNodeAttributeValue("nodeType0",2,"artist");
    tree.getNodeAttributeValue("nodeType0",2,"doctor");
    tree.getNodeAttributeValue("nodeType0",2,"educator");
    tree.getNodeAttributeValue("nodeType0",2,"engineer");
    tree.getNodeAttributeValue("nodeType0",2,"executive");
    tree.getNodeAttributeValue("nodeType0",2,"healthcare");
    tree.getNodeAttributeValue("nodeType0",2,"homemaker");
    tree.getNodeAttributeValue("nodeType0",2,"lawyer");
    tree.getNodeAttributeValue("nodeType0",2,"librarian");
    tree.getNodeAttributeValue("nodeType0",2,"marketing");
    tree.getNodeAttributeValue("nodeType0",2,"none");
    tree.getNodeAttributeValue("nodeType0",2,"other");
    tree.getNodeAttributeValue("nodeType0",2,"programmer");
    tree.getNodeAttributeValue("nodeType0",2,"retired");
    tree.getNodeAttributeValue("nodeType0",2,"salesman");
    tree.getNodeAttributeValue("nodeType0",2,"scientist");
    tree.getNodeAttributeValue("nodeType0",2,"student");
    tree.getNodeAttributeValue("nodeType0",2,"technician");
    tree.getNodeAttributeValue("nodeType0",2,"writer");
    diff += clock() - start;
    ...
    diff=0;
    start = clock();
    tree.getNodeAttributeValue("nodeType2",7,"unknown");
    tree.getNodeAttributeValue("nodeType2",7,"Action");
    tree.getNodeAttributeValue("nodeType2",7,"Adventure");
    tree.getNodeAttributeValue("nodeType2",7,"Animation");
    tree.getNodeAttributeValue("nodeType2",7,"Children's");
    tree.getNodeAttributeValue("nodeType2",7,"Comedy");
    tree.getNodeAttributeValue("nodeType2",7,"Crime");
    tree.getNodeAttributeValue("nodeType2",7,"Documentary");
    tree.getNodeAttributeValue("nodeType2",7,"Drama");
    tree.getNodeAttributeValue("nodeType2",7,"Fantasy");
    tree.getNodeAttributeValue("nodeType2",7,"Film-Noir");
    tree.getNodeAttributeValue("nodeType2",7,"Horror");
    tree.getNodeAttributeValue("nodeType2",7,"Musical");
    tree.getNodeAttributeValue("nodeType2",7,"Mystery");
    tree.getNodeAttributeValue("nodeType2",7,"Romance");
    tree.getNodeAttributeValue("nodeType2",7,"Sci-Fi");
    tree.getNodeAttributeValue("nodeType2",7,"Thriller");
    tree.getNodeAttributeValue("nodeType2",7,"War");
    tree.getNodeAttributeValue("nodeType2",7,"Western");
    diff += clock() - start;
